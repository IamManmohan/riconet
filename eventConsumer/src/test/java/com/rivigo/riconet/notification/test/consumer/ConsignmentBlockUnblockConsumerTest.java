...
public class ConsignmentBlockUnblockConsumerTest {
  ...
  @InjectMocks
  private ConsignmentBlockUnblockConsumer consignmentBlockUnblockConsumer = new ConsignmentBlockUnblockConsumer(objectMapper, consignmentBlockUnblockService, topicNameConfig);
  ...
  public void getTopicTest() {
    ...
    Mockito.when(topicNameConfig.enrichedEventSinkTopic())
        .thenReturn(enrichedEventSink);
  ...
  public void getErrorTopicTest() {
    ...
    Mockito.when(topicNameConfig.enrichedEventSinkTopic())
        .thenReturn(enrichedEventSinkEroor);
