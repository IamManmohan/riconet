...
public class BfPickupChargesActionConsumerTest {
  ...
  @InjectMocks
  private BfPickupChargesActionConsumer bfPickupChargesActionConsumer;
  ...
  public void eventsToBeConsumed(){
    List<EventName> expected= Arrays.asList(EventName.CN_COMPLETION_ALL_INSTANCES,EventName.CN_DELETED,EventName.PICKUP_COMPLETION);
  ...
  public void  processMessageTest(){
    String str = bfPickupChargesActionConsumer.processMessage("{\"eventName\"\n"
