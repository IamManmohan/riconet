...
public class NotificationTest {
  ...
  @Autowired DocIssueNotificationConsumer docIssueNotificationConsumer;

  @Autowired DEPSNotificationConsumer depsNotificationConsumer;

  @Autowired PickupNotificationConsumer pickupNotificationConsumer;

  @Autowired AppointmentNotificationConsumer appointmentNotificationConsumer;
