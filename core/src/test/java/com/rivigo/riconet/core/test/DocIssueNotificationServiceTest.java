...
public class DocIssueNotificationServiceTest {
  ...
  @Autowired DocumentIssueNotificationService documentIssueNotificationService;

  @Autowired ConsignmentScheduleService consignmentScheduleService;

  @Autowired ZoomPropertyService zoomPropertyService;

  @Autowired ConsignmentScheduleRepository consignmentScheduleRepository;
