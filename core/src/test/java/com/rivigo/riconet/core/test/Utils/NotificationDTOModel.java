...
public class NotificationDTOModel {
  ...
  public static NotificationDTO getNotificationDTO(EventName eventName) {
    ...
    metadata.put(
        FieldName.OLD_ASSIGNEE_GROUP_NAME_OR_ASSIGNEE_EMAIL.toString(),
        "ramesh.chandra@rivigo.com");
    metadata.put(
        FieldName.ASSIGNEE_GROUP_NAME_OR_ASSIGNEE_EMAIL.toString(), "rameshc10695@gmail.com");
    ...
    metadata.put(
        FieldName.COMMENT_HISTORY.toString(),
