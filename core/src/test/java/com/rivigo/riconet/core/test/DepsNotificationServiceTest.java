...
public class DepsNotificationServiceTest extends TesterBase {
  @Autowired DEPSRecordService depsRecordService;

  @Autowired TransportationPartnerMappingRepository transportationPartnerMappingRepository;
  ...
  public void tripUnloadingNotification() {
    String str =
        "[{\"id\":2,\"consignmentId\":2,\"depsType\":\"SHORTAGE\",\"tripId\":1,\"tripType\":\"TRIP\",\"taskId\":3,\"reportedById\":1505,\"inboundLocationId\":20,\"depsTaskType\":\"UNLOADING\"}]";
    processNotification(str);
  }
  ...
  public void returnScanNotification() {
    ...
    String str =
        "[{\"id\":3,\"consignmentId\":4,\"depsType\":\"SHORTAGE\",\"tripId\":1,\"tripType\":\"DRS\",\"taskId\":5,\"reportedById\":1505,\"inboundLocationId\":20,\"depsTaskType\":\"RETURN_SCAN\"}]";
  ...
  public void instockNotification() {
    String str =
        "[{\"id\":4,\"consignmentId\":3,\"depsType\":\"SHORTAGE\",\"taskId\":25,\"reportedById\":1505,\"inboundLocationId\":20,\"depsTaskType\":\"STOCK_CHECK\"}]";
    processNotification(str);
  }
