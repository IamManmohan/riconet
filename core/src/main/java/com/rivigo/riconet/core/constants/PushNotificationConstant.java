...
public class PushNotificationConstant {
  ...
  public static final String CN_FIRST_DISPATCH_IDENTIFIER_VALUE = "DISPATCHED";
  ...
  public static final String PICKUP_REACHED_AT_LOCATION_NOTIFICATION_TITLE_VALUE =
      "Partner reached";
  public static final String CN_FIRST_DISPATCH_NOTIFICATION_TITLE_VALUE = "Dispatched";
