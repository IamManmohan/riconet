...
public class ZoomTicketingConstant {
  ...
  public static final String QC_MEASUREMENT_TASK_CREATION_MESSAGE = "Complete the QC measurement task by clicking \"COMPLETE QC\" button at the top";
  ...
  public static final String QC_AUTO_CLOSURE_MESSAGE_DISPATCH = "The ticket got auto-closed because the CN has been dispatched from the Source OU, without QC completion";
  ...
  public static final String QC_AUTO_CLOSURE_MESSAGE_CNOTE_TYPE_CHANGE = "The task got auto closed because of change of CN from credit to retail";
