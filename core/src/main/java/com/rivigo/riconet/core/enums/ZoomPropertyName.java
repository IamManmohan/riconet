...
public enum ZoomPropertyName {
    ...
    ,BOOLEAN_TESTING
    , PICKUP_REACHED_SMS_STRING, PICKUP_DELAYED_SMS_STRING, PICKUP_ASSIGNED_TO_USER_SMS_STRING, PICKUP_ASSIGNED_BP_USER_SMS_STRING, PICKUP_CREATED_SMS_STRING, PICKUP_DELAY_NOTIFICATION_SECONDS, DEFAULT_SMS_NUMBER, INTEGER_TESTING
}
