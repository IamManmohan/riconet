...
public enum ZoomPropertyName {
    ...
    , APPOINTMENT_MISSED_SUBJECT, APPOINTMENT_MISSED_EMAIL, APPOINTMENT_MISSED_SUMMARY_SUBJECT, APPOINTMENT_MISSED_SUMMARY_EMAIL, APPOINTMENT_WRONG_UNDELIVERED_MARKED_SUBJECT, APPOINTMENT_WRONG_UNDELIVERED_MARKED_EMAIL, APPOINTMENT_NOT_OFD_EMAIL, APPOINTMENT_NOT_OFD_SUBJECT
    , RETAIL_COD_CN_CREATION_CONSIGNEE_SMS_STRING, RETAIL_COD_CN_CREATION_CONSIGNOR_SMS_STRING, RETAIL_PREPAID_CN_CREATION_CONSIGNOR_SMS_STRING, RETAIL_PREPAID_CN_CREATION_CONSIGNEE_SMS_STRING, RETAIL_PREPAID_CN_UPDATE_CONSIGNEE_SMS_STRING, RETAIL_PREPAID_CN_UPDATE_CONSIGNOR_SMS_STRING, RETAIL_COD_CN_UPDATE_CONSIGNEE_SMS_STRING, RETAIL_COD_CN_UPDATE_CONSIGNOR_SMS_STRING, RETAIL_COD_DRS_DISPATCH_CONSIGNEE_SMS_STRING, RETAIL_COLLECTION_CREATION_USER_SMS_STRING, RETAIL_COLLECTION_CREATION_BP_SMS_STRING, RETAIL_HANDOVER_USER_SMS_STRING, RETAIL_HANDOVER_BP_SMS_STRING, RETAIL_COLLECTION_CREATION_BP_CAPTAIN_SMS_STRING, APPOINTMENT_DELIVERED_LATE_DIFFERENT_DAY_EMAIL
