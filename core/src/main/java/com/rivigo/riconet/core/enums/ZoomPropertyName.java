...
public enum ZoomPropertyName {
    ...
    , APPOINTMENT_MISSED_SUBJECT, APPOINTMENT_MISSED_EMAIL, APPOINTMENT_MISSED_SUMMARY_SUBJECT, APPOINTMENT_MISSED_SUMMARY_EMAIL, APPOINTMENT_WRONG_UNDELIVERED_MARKED_SUBJECT, APPOINTMENT_WRONG_UNDELIVERED_MARKED_EMAIL, APPOINTMENT_DELIVERED_LATE_DIFFERENT_DAY_EMAIL
}
